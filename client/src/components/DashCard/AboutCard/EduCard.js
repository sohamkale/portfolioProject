...
//     const [eduCardArray, setEduCardArray] = useState([{
//         // 'id': ,
//         // 'university': null,
//         // 'college': null,
//         // 'degree': null,
...
//                     if(snap.key === "universityName"){
//                         let newArray = [...eduCardArray]
//                         newArray
//                     }else if(snap.key === "collegeName"){
...
//                 } )
//                 console.log(refEducation)
//                 console.log(userSnapshot)
//                 console.log(snapshot)
//                 // setEduCardArray(eduCardArray.concat({
//                 //     'id': snapshot.key,
//                 //      'university': null,
//                 //     'college': null,
//                 //     'degree': null,
...
//     const onClickSave = (e, index) => {
//         refEducation.on("value", function(userSnapshot) {
//             userSnapshot.forEach(function(snapshot) {
//                 if(snapshot.key === index){
//                 }
//             });
//         });
//         refEducation.update({
